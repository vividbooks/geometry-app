-- Úkol „Kružnice trojúhelníku vepsaná“: 3 kroky se sdíleným plátnem
-- (ostroúhlý ABC, pravoúhlý DEF, tupoúhlý KLM). Spusť v Supabase SQL Editoru.
